...
export default function Footer() {
  return (
    <footer
      className="bg-gradient-to-br from-dark via-[#141414] to-dark text-white"
      role="contentinfo"
    >
      {/* Main footer content */}
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="flex flex-col gap-4 lg:col-span-1">
            ...
            <div className="flex flex-col gap-2 mt-2">
              <a
                href="tel:0706888600"
                className="flex items-center gap-2 text-surface/80 hover:text-surface-light text-sm transition-colors"
              ...
              <a
                ...
                className="flex items-center gap-2 text-surface/80 hover:text-green-400 text-sm transition-colors"
            ...
            <ul className="flex flex-col gap-3" role="list">
              {QUICK_LINKS.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-surface/80 hover:text-surface-light text-sm transition-colors hover:translate-x-1 inline-block"
                  >
                    → {link.label}
                  </a>
                </li>
            ...
            <ul className="flex flex-col gap-3" role="list">
              {SERVICE_LINKS.map((service) => (
                <li key={service}>
                  <a
                    href="#services"
                    className="text-surface/80 hover:text-surface-light text-sm transition-colors"
                  >
                    {service}
                  </a>
                </li>
            ...
            <ul className="flex flex-col gap-4" role="list">
              ...
              <li className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <a href="tel:0706888600" className="text-surface/80 hover:text-surface-light text-sm transition-colors">
                    📞 0706888600
                  </a>
                </div>
              </li>
              ...
              <li className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <a href="tel:0703222356" className="text-surface/80 hover:text-surface-light text-sm transition-colors">
                    📞 0703222356
                  </a>
                </div>
              </li>
      ...
      <div className="border-t border-glass-border-dark">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-surface/60 text-sm text-center sm:text-left">
            © 2026 Mock Electrical and Electronics Ltd. All rights reserved.
          </p>
          <p className="text-surface/40 text-xs flex items-center gap-1">
            Built with <FaHeart className="text-primary mx-0.5" aria-hidden="true" /> in Kenya
          </p>
        </div>
      </div>
    </footer>
